                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block">
                                <img style="max-width: 550px" src="{{asset('asset/img/foto_content2.png')}}" alt="">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4 w-2">{{$title;}}</h1>
                                    </div>
                              ...
                              @endif
                                ...
                                @endif
                                    <form class="user" action="{{url('login-user')}}" method="POST">
                                        @csrf
